...
public class AuswahlActivity extends AppCompatActivity // ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* getActionBar geht in Version 1.1 unter android-22 nicht
        */
        getSupportActionBar().setTitle("DLF Version "
                + versionName + " "
                //+ versionCode
                + " von "
                + ft.format(dNow));
    ...
    public static final BenutzerInfo newInstance(int title, String message) {
    ...
    public void onStart() {
        ...
        if (debug > 1)
            taste.setText(String.format("AuswahlActivity.onStart: Stoppe den Mediaplayer. debug=%d", debug));
        else
...
/*
    new MachSerienauswahlButtons(AuswahlActivity.this, this,
...
*/
    ...
    public void onFinishEditDialog(String inputText) {
        ...
        if (!suchbegriff.equals("")) {
            ...
            //serien = new Serien(AuswahlActivity.this, this, debug, mediaPlayer);
            serien.append(serie);
        }
    }
